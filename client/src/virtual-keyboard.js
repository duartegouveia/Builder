...
// Frequency dictionaries for autocomplete (common words)
const dictionaries = {
  pt: [
    ...
    'aquilo', 'porque', 'porquê', 'onde', 'aonde', 'cujo', 'cuja', 'cujos', 'cujas',
    // Verbos comuns
    'estou', 'está', 'estamos', 'estão', 'estive', 'esteve', 'estivemos', 'estiveram',
    'estava', 'estávamos', 'estavam', 'esteja', 'estejam', 'estiver', 'estivermos',
    'hei', 'há', 'havemos', 'hão', 'houve', 'houvemos', 'houveram',
    'sou', 'és', 'somos', 'são', 'era', 'eras', 'éramos', 'eram', 'fui', 'foste', 'fomos',
    'tenho', 'tens', 'temos', 'têm', 'tinha', 'tinhas', 'tínhamos', 'tinham', 'tive', 'tiveste',
    'fazer', 'faço', 'faz', 'fazemos', 'fazem', 'fez', 'fizemos', 'fizeram', 'fazia', 'faziam',
    'poder', 'posso', 'pode', 'podemos', 'podem', 'pude', 'pudemos', 'puderam', 'podia', 'podiam',
    'querer', 'quero', 'quer', 'queremos', 'querem', 'quis', 'quisemos', 'quiseram', 'queria',
    'dizer', 'digo', 'diz', 'dizemos', 'dizem', 'disse', 'dissemos', 'disseram', 'dizia',
    'ver', 'vejo', 'vê', 'vemos', 'veem', 'vi', 'viu', 'vimos', 'viram', 'via', 'viam',
    'dar', 'dou', 'dá', 'damos', 'dão', 'dei', 'deu', 'demos', 'deram', 'dava', 'davam',
    'ir', 'vou', 'vai', 'vamos', 'vão', 'fui', 'foi', 'fomos', 'foram', 'ia', 'iam',
    'vir', 'venho', 'vem', 'vimos', 'vêm', 'vim', 'veio', 'viemos', 'vieram', 'vinha', 'vinham',
    'saber', 'sei', 'sabe', 'sabemos', 'sabem', 'soube', 'soubemos', 'souberam', 'sabia', 'sabiam',
    'pôr', 'ponho', 'põe', 'pomos', 'põem', 'pus', 'pôs', 'pusemos', 'puseram', 'punha', 'punham',
    'ficar', 'fico', 'fica', 'ficamos', 'ficam', 'fiquei', 'ficou', 'ficamos', 'ficaram',
    'achar', 'acho', 'acha', 'achamos', 'acham', 'achei', 'achou', 'achamos', 'acharam',
    'pensar', 'penso', 'pensa', 'pensamos', 'pensam', 'pensei', 'pensou', 'pensaram',
    'falar', 'falo', 'fala', 'falamos', 'falam', 'falei', 'falou', 'falaram',
    'trabalhar', 'trabalho', 'trabalha', 'trabalhamos', 'trabalham', 'trabalhei', 'trabalhou',
    'precisar', 'preciso', 'precisa', 'precisamos', 'precisam', 'precisei', 'precisou',
    'gostar', 'gosto', 'gosta', 'gostamos', 'gostam', 'gostei', 'gostou', 'gostaram',
    'amar', 'amo', 'ama', 'amamos', 'amam', 'amei', 'amou', 'amaram',
    'comer', 'como', 'come', 'comemos', 'comem', 'comi', 'comeu', 'comeram',
    'beber', 'bebo', 'bebe', 'bebemos', 'bebem', 'bebi', 'bebeu', 'beberam',
    'dormir', 'durmo', 'dorme', 'dormimos', 'dormem', 'dormi', 'dormiu', 'dormiram',
    'andar', 'ando', 'anda', 'andamos', 'andam', 'andei', 'andou', 'andaram',
    'correr', 'corro', 'corre', 'corremos', 'correm', 'corri', 'correu', 'correram',
    'ler', 'leio', 'lê', 'lemos', 'leem', 'li', 'leu', 'lemos', 'leram',
    'escrever', 'escrevo', 'escreve', 'escrevemos', 'escrevem', 'escrevi', 'escreveu',
    'ouvir', 'ouço', 'ouve', 'ouvimos', 'ouvem', 'ouvi', 'ouviu', 'ouviram',
    'sentir', 'sinto', 'sente', 'sentimos', 'sentem', 'senti', 'sentiu', 'sentiram',
    'viver', 'vivo', 'vive', 'vivemos', 'vivem', 'vivi', 'viveu', 'viveram',
    'morrer', 'morro', 'morre', 'morremos', 'morrem', 'morri', 'morreu', 'morreram',
    'nascer', 'nasço', 'nasce', 'nascemos', 'nascem', 'nasci', 'nasceu', 'nasceram',
    'crescer', 'cresço', 'cresce', 'crescemos', 'crescem', 'cresci', 'cresceu', 'cresceram',
    'aprender', 'aprendo', 'aprende', 'aprendemos', 'aprendem', 'aprendi', 'aprendeu',
    'ensinar', 'ensino', 'ensina', 'ensinamos', 'ensinam', 'ensinei', 'ensinou',
    'ajudar', 'ajudo', 'ajuda', 'ajudamos', 'ajudam', 'ajudei', 'ajudou', 'ajudaram',
    'comprar', 'compro', 'compra', 'compramos', 'compram', 'comprei', 'comprou',
    'vender', 'vendo', 'vende', 'vendemos', 'vendem', 'vendi', 'vendeu', 'venderam',
    'pagar', 'pago', 'paga', 'pagamos', 'pagam', 'paguei', 'pagou', 'pagaram',
    'receber', 'recebo', 'recebe', 'recebemos', 'recebem', 'recebi', 'recebeu',
    'enviar', 'envio', 'envia', 'enviamos', 'enviam', 'enviei', 'enviou', 'enviaram',
    'mandar', 'mando', 'manda', 'mandamos', 'mandam', 'mandei', 'mandou', 'mandaram',
    'trazer', 'trago', 'traz', 'trazemos', 'trazem', 'trouxe', 'trouxemos', 'trouxeram',
    'levar', 'levo', 'leva', 'levamos', 'levam', 'levei', 'levou', 'levaram',
    'deixar', 'deixo', 'deixa', 'deixamos', 'deixam', 'deixei', 'deixou', 'deixaram',
    'encontrar', 'encontro', 'encontra', 'encontramos', 'encontram', 'encontrei', 'encontrou',
    'procurar', 'procuro', 'procura', 'procuramos', 'procuram', 'procurei', 'procurou',
    'perder', 'perco', 'perde', 'perdemos', 'perdem', 'perdi', 'perdeu', 'perderam',
    'ganhar', 'ganho', 'ganha', 'ganhamos', 'ganham', 'ganhei', 'ganhou', 'ganharam',
    'jogar', 'jogo', 'joga', 'jogamos', 'jogam', 'joguei', 'jogou', 'jogaram',
    'brincar', 'brinco', 'brinca', 'brincamos', 'brincam', 'brinquei', 'brincou',
    'cantar', 'canto', 'canta', 'cantamos', 'cantam', 'cantei', 'cantou', 'cantaram',
    'dançar', 'danço', 'dança', 'dançamos', 'dançam', 'dancei', 'dançou', 'dançaram',
    'nadar', 'nado', 'nada', 'nadamos', 'nadam', 'nadei', 'nadou', 'nadaram',
    'voar', 'voo', 'voa', 'voamos', 'voam', 'voei', 'voou', 'voaram',
    'entrar', 'entro', 'entra', 'entramos', 'entram', 'entrei', 'entrou', 'entraram',
    'sair', 'saio', 'sai', 'saímos', 'saem', 'saí', 'saiu', 'saíram',
    'abrir', 'abro', 'abre', 'abrimos', 'abrem', 'abri', 'abriu', 'abriram',
    'fechar', 'fecho', 'fecha', 'fechamos', 'fecham', 'fechei', 'fechou', 'fecharam',
    'ligar', 'ligo', 'liga', 'ligamos', 'ligam', 'liguei', 'ligou', 'ligaram',
    'desligar', 'desligo', 'desliga', 'desligamos', 'desligam', 'desliguei', 'desligou',
    'começar', 'começo', 'começa', 'começamos', 'começam', 'comecei', 'começou',
    'acabar', 'acabo', 'acaba', 'acabamos', 'acabam', 'acabei', 'acabou', 'acabaram',
    'terminar', 'termino', 'termina', 'terminamos', 'terminam', 'terminei', 'terminou',
    'continuar', 'continuo', 'continua', 'continuamos', 'continuam', 'continuei', 'continuou',
    'parar', 'paro', 'para', 'paramos', 'param', 'parei', 'parou', 'pararam',
    'esperar', 'espero', 'espera', 'esperamos', 'esperam', 'esperei', 'esperou',
    'lembrar', 'lembro', 'lembra', 'lembramos', 'lembram', 'lembrei', 'lembrou',
    'esquecer', 'esqueço', 'esquece', 'esquecemos', 'esquecem', 'esqueci', 'esqueceu',
    'conhecer', 'conheço', 'conhece', 'conhecemos', 'conhecem', 'conheci', 'conheceu',
    'reconhecer', 'reconheço', 'reconhece', 'reconhecemos', 'reconhecem', 'reconheci',
    'parecer', 'pareço', 'parece', 'parecemos', 'parecem', 'pareci', 'pareceu',
    'aparecer', 'apareço', 'aparece', 'aparecemos', 'aparecem', 'apareci', 'apareceu',
    'desaparecer', 'desapareço', 'desaparece', 'desaparecemos', 'desaparecem', 'desapareci',
    'mudar', 'mudo', 'muda', 'mudamos', 'mudam', 'mudei', 'mudou', 'mudaram',
    'trocar', 'troco', 'troca', 'trocamos', 'trocam', 'troquei', 'trocou', 'trocaram',
    'usar', 'uso', 'usa', 'usamos', 'usam', 'usei', 'usou', 'usaram',
    'criar', 'crio', 'cria', 'criamos', 'criam', 'criei', 'criou', 'criaram',
    'construir', 'construo', 'constrói', 'construímos', 'constroem', 'construí', 'construiu',
    'destruir', 'destruo', 'destrói', 'destruímos', 'destroem', 'destruí', 'destruiu',
    'limpar', 'limpo', 'limpa', 'limpamos', 'limpam', 'limpei', 'limpou', 'limparam',
    'lavar', 'lavo', 'lava', 'lavamos', 'lavam', 'lavei', 'lavou', 'lavaram',
    'cozinhar', 'cozinho', 'cozinha', 'cozinhamos', 'cozinham', 'cozinhei', 'cozinhou',
    'preparar', 'preparo', 'prepara', 'preparamos', 'preparam', 'preparei', 'preparou',
    'servir', 'sirvo', 'serve', 'servimos', 'servem', 'servi', 'serviu', 'serviram',
    'escolher', 'escolho', 'escolhe', 'escolhemos', 'escolhem', 'escolhi', 'escolheu',
    'decidir', 'decido', 'decide', 'decidimos', 'decidem', 'decidi', 'decidiu',
    'tentar', 'tento', 'tenta', 'tentamos', 'tentam', 'tentei', 'tentou', 'tentaram',
    'conseguir', 'consigo', 'consegue', 'conseguimos', 'conseguem', 'consegui', 'conseguiu',
    'permitir', 'permito', 'permite', 'permitimos', 'permitem', 'permiti', 'permitiu',
    'proibir', 'proíbo', 'proíbe', 'proibimos', 'proíbem', 'proibi', 'proibiu',
    'aceitar', 'aceito', 'aceita', 'aceitamos', 'aceitam', 'aceitei', 'aceitou',
    'recusar', 'recuso', 'recusa', 'recusamos', 'recusam', 'recusei', 'recusou',
    'oferecer', 'ofereço', 'oferece', 'oferecemos', 'oferecem', 'ofereci', 'ofereceu',
    'pedir', 'peço', 'pede', 'pedimos', 'pedem', 'pedi', 'pediu', 'pediram',
    'responder', 'respondo', 'responde', 'respondemos', 'respondem', 'respondi', 'respondeu',
    'perguntar', 'pergunto', 'pergunta', 'perguntamos', 'perguntam', 'perguntei', 'perguntou',
    'explicar', 'explico', 'explica', 'explicamos', 'explicam', 'expliquei', 'explicou',
    'entender', 'entendo', 'entende', 'entendemos', 'entendem', 'entendi', 'entendeu',
    'compreender', 'compreendo', 'compreende', 'compreendemos', 'compreendem', 'compreendi',
    'acreditar', 'acredito', 'acredita', 'acreditamos', 'acreditam', 'acreditei', 'acreditou',
    'duvidar', 'duvido', 'duvida', 'duvidamos', 'duvidam', 'duvidei', 'duvidou',
    'confiar', 'confio', 'confia', 'confiamos', 'confiam', 'confiei', 'confiou',
    'desconfiar', 'desconfio', 'desconfia', 'desconfiamos', 'desconfiam', 'desconfiei',
    'preocupar', 'preocupo', 'preocupa', 'preocupamos', 'preocupam', 'preocupei', 'preocupou',
    'importar', 'importo', 'importa', 'importamos', 'importam', 'importei', 'importou',
    'interessar', 'interesso', 'interessa', 'interessamos', 'interessam', 'interessei',
    'adorar', 'adoro', 'adora', 'adoramos', 'adoram', 'adorei', 'adorou', 'adoraram',
    'odiar', 'odeio', 'odeia', 'odiamos', 'odeiam', 'odiei', 'odiou', 'odiaram',
    'preferir', 'prefiro', 'prefere', 'preferimos', 'preferem', 'preferi', 'preferiu',
    'desejar', 'desejo', 'deseja', 'desejamos', 'desejam', 'desejei', 'desejou',
    'sonhar', 'sonho', 'sonha', 'sonhamos', 'sonham', 'sonhei', 'sonhou', 'sonharam',
    'imaginar', 'imagino', 'imagina', 'imaginamos', 'imaginam', 'imaginei', 'imaginou',
    'lembrar', 'lembro', 'lembra', 'lembramos', 'lembram', 'lembrei', 'lembrou',
    'recordar', 'recordo', 'recorda', 'recordamos', 'recordam', 'recordei', 'recordou',
    'notar', 'noto', 'nota', 'notamos', 'notam', 'notei', 'notou', 'notaram',
    'reparar', 'reparo', 'repara', 'reparamos', 'reparam', 'reparei', 'reparou',
    'observar', 'observo', 'observa', 'observamos', 'observam', 'observei', 'observou',
    'olhar', 'olho', 'olha', 'olhamos', 'olham', 'olhei', 'olhou', 'olharam',
    'mostrar', 'mostro', 'mostra', 'mostramos', 'mostram', 'mostrei', 'mostrou',
    'esconder', 'escondo', 'esconde', 'escondemos', 'escondem', 'escondi', 'escondeu',
    'revelar', 'revelo', 'revela', 'revelamos', 'revelam', 'revelei', 'revelou',
    'guardar', 'guardo', 'guarda', 'guardamos', 'guardam', 'guardei', 'guardou',
    'proteger', 'protejo', 'protege', 'protegemos', 'protegem', 'protegi', 'protegeu',
    'defender', 'defendo', 'defende', 'defendemos', 'defendem', 'defendi', 'defendeu',
    'atacar', 'ataco', 'ataca', 'atacamos', 'atacam', 'ataquei', 'atacou', 'atacaram',
    'lutar', 'luto', 'luta', 'lutamos', 'lutam', 'lutei', 'lutou', 'lutaram',
    'vencer', 'venço', 'vence', 'vencemos', 'vencem', 'venci', 'venceu', 'venceram',
    'perder', 'perco', 'perde', 'perdemos', 'perdem', 'perdi', 'perdeu', 'perderam',
    'subir', 'subo', 'sobe', 'subimos', 'sobem', 'subi', 'subiu', 'subiram',
    'descer', 'desço', 'desce', 'descemos', 'descem', 'desci', 'desceu', 'desceram',
    'cair', 'caio', 'cai', 'caímos', 'caem', 'caí', 'caiu', 'caíram',
    'levantar', 'levanto', 'levanta', 'levantamos', 'levantam', 'levantei', 'levantou',
    'sentar', 'sento', 'senta', 'sentamos', 'sentam', 'sentei', 'sentou', 'sentaram',
    'deitar', 'deito', 'deita', 'deitamos', 'deitam', 'deitei', 'deitou', 'deitaram',
    'acordar', 'acordo', 'acorda', 'acordamos', 'acordam', 'acordei', 'acordou',
    'vestir', 'visto', 'veste', 'vestimos', 'vestem', 'vesti', 'vestiu', 'vestiram',
    'tirar', 'tiro', 'tira', 'tiramos', 'tiram', 'tirei', 'tirou', 'tiraram',
    'colocar', 'coloco', 'coloca', 'colocamos', 'colocam', 'coloquei', 'colocou',
    'segurar', 'seguro', 'segura', 'seguramos', 'seguram', 'segurei', 'segurou',
    'soltar', 'solto', 'solta', 'soltamos', 'soltam', 'soltei', 'soltou', 'soltaram',
    'puxar', 'puxo', 'puxa', 'puxamos', 'puxam', 'puxei', 'puxou', 'puxaram',
    'empurrar', 'empurro', 'empurra', 'empurramos', 'empurram', 'empurrei', 'empurrou',
    'tocar', 'toco', 'toca', 'tocamos', 'tocam', 'toquei', 'tocou', 'tocaram',
    'bater', 'bato', 'bate', 'batemos', 'batem', 'bati', 'bateu', 'bateram',
    'cortar', 'corto', 'corta', 'cortamos', 'cortam', 'cortei', 'cortou', 'cortaram',
    'quebrar', 'quebro', 'quebra', 'quebramos', 'quebram', 'quebrei', 'quebrou',
    'consertar', 'conserto', 'conserta', 'consertamos', 'consertam', 'consertei', 'consertou',
    'reparar', 'reparo', 'repara', 'reparamos', 'reparam', 'reparei', 'reparou',
    // Substantivos comuns
    'casa', 'tempo', 'ano', 'dia', 'vez', 'coisa', 'homem', 'mulher', 'vida', 'mundo',
    'mão', 'parte', 'lugar', 'caso', 'semana', 'trabalho', 'governo', 'país', 'problema',
    'ponto', 'pessoa', 'hora', 'estado', 'empresa', 'grupo', 'momento', 'cidade', 'nome',
    'família', 'lado', 'filho', 'olho', 'água', 'exemplo', 'porta', 'pai', 'mãe', 'terra',
    'dinheiro', 'história', 'poder', 'forma', 'ideia', 'tipo', 'lei', 'corpo', 'palavra',
    'escola', 'amigo', 'guerra', 'livro', 'mesa', 'noite', 'rua', 'morte', 'caminho',
    'meio', 'modo', 'filho', 'filha', 'irmão', 'irmã', 'avô', 'avó', 'tio', 'tia',
    'primo', 'prima', 'sobrinho', 'sobrinha', 'neto', 'neta', 'marido', 'esposa', 'namorado',
    'namorada', 'bebé', 'criança', 'jovem', 'adulto', 'idoso', 'menino', 'menina', 'rapaz',
    'rapariga', 'senhor', 'senhora', 'doutor', 'doutora', 'professor', 'professora',
    'médico', 'médica', 'enfermeiro', 'enfermeira', 'advogado', 'advogada', 'engenheiro',
    'arquitecto', 'cientista', 'artista', 'músico', 'cantor', 'cantora', 'actor', 'actriz',
    'escritor', 'escritora', 'jornalista', 'político', 'polícia', 'bombeiro', 'soldado',
    'cozinheiro', 'cozinheira', 'padeiro', 'padeira', 'vendedor', 'vendedora', 'motorista',
    'piloto', 'capitão', 'presidente', 'ministro', 'rei', 'rainha', 'príncipe', 'princesa',
    'carro', 'bicicleta', 'mota', 'autocarro', 'comboio', 'avião', 'barco', 'navio',
    'metro', 'táxi', 'camião', 'ambulância', 'helicóptero', 'foguetão', 'satélite',
    'computador', 'telemóvel', 'telefone', 'televisão', 'rádio', 'câmara', 'máquina',
    'internet', 'email', 'mensagem', 'carta', 'jornal', 'revista', 'fotografia', 'vídeo',
    'música', 'filme', 'teatro', 'cinema', 'concerto', 'exposição', 'museu', 'galeria',
    'restaurante', 'café', 'bar', 'hotel', 'hospital', 'farmácia', 'banco', 'loja',
    'supermercado', 'mercado', 'centro', 'praça', 'parque', 'jardim', 'praia', 'montanha',
    'rio', 'mar', 'oceano', 'lago', 'floresta', 'campo', 'cidade', 'vila', 'aldeia',
    'país', 'continente', 'planeta', 'universo', 'sol', 'lua', 'estrela', 'céu', 'nuvem',
    'chuva', 'neve', 'vento', 'tempestade', 'trovão', 'relâmpago', 'arco-íris', 'fogo',
    'pão', 'arroz', 'massa', 'carne', 'peixe', 'frango', 'legume', 'fruta', 'salada',
    'sopa', 'café', 'chá', 'leite', 'sumo', 'água', 'vinho', 'cerveja', 'bolo', 'sobremesa',
    'pequeno-almoço', 'almoço', 'jantar', 'lanche', 'refeição', 'prato', 'copo', 'garrafa',
    'faca', 'garfo', 'colher', 'panela', 'frigideira', 'forno', 'fogão', 'frigorífico',
    'roupa', 'camisa', 'calças', 'vestido', 'saia', 'casaco', 'chapéu', 'sapato', 'bota',
    'sandália', 'meias', 'cuecas', 'soutien', 'gravata', 'cinto', 'relógio', 'anel',
    'pulseira', 'colar', 'brinco', 'óculos', 'mala', 'carteira', 'chave', 'guarda-chuva',
    'cama', 'sofá', 'cadeira', 'mesa', 'armário', 'estante', 'espelho', 'quadro', 'tapete',
    'cortina', 'almofada', 'cobertor', 'lençol', 'toalha', 'sabonete', 'champô', 'escova',
    'pente', 'secador', 'máquina', 'aspirador', 'ferro', 'vassoura', 'balde', 'lixo',
    'cão', 'gato', 'pássaro', 'peixe', 'cavalo', 'vaca', 'porco', 'galinha', 'ovelha',
    'cabra', 'coelho', 'rato', 'leão', 'tigre', 'elefante', 'girafa', 'macaco', 'urso',
    'lobo', 'raposa', 'veado', 'baleia', 'golfinho', 'tubarão', 'cobra', 'lagarto',
    'tartaruga', 'sapo', 'borboleta', 'abelha', 'formiga', 'mosca', 'mosquito', 'aranha',
    'árvore', 'flor', 'planta', 'folha', 'raiz', 'tronco', 'ramo', 'fruto', 'semente',
    'rosa', 'girassol', 'margarida', 'tulipa', 'lírio', 'cravo', 'violeta', 'hortênsia',
    'número', 'letra', 'palavra', 'frase', 'texto', 'parágrafo', 'página', 'capítulo',
    'livro', 'história', 'conto', 'poema', 'romance', 'notícia', 'artigo', 'ensaio',
    'cor', 'vermelho', 'azul', 'verde', 'amarelo', 'laranja', 'roxo', 'rosa', 'castanho',
    'preto', 'branco', 'cinzento', 'dourado', 'prateado', 'bege', 'turquesa', 'violeta',
    // Adjectivos
    'grande', 'pequeno', 'alto', 'baixo', 'largo', 'estreito', 'gordo', 'magro', 'forte',
    'fraco', 'jovem', 'velho', 'novo', 'antigo', 'moderno', 'bom', 'mau', 'melhor', 'pior',
    'bonito', 'feio', 'lindo', 'horrível', 'simples', 'complexo', 'fácil', 'difícil',
    'rápido', 'lento', 'quente', 'frio', 'morno', 'gelado', 'seco', 'molhado', 'húmido',
    'limpo', 'sujo', 'claro', 'escuro', 'brilhante', 'opaco', 'liso', 'áspero', 'macio',
    'duro', 'mole', 'pesado', 'leve', 'cheio', 'vazio', 'rico', 'pobre', 'caro', 'barato',
    'grátis', 'livre', 'ocupado', 'aberto', 'fechado', 'junto', 'separado', 'igual',
    'diferente', 'parecido', 'contrário', 'certo', 'errado', 'verdadeiro', 'falso',
    'real', 'imaginário', 'possível', 'impossível', 'provável', 'improvável', 'necessário',
    'desnecessário', 'importante', 'insignificante', 'útil', 'inútil', 'interessante',
    'aborrecido', 'divertido', 'triste', 'feliz', 'alegre', 'contente', 'satisfeito',
    'insatisfeito', 'zangado', 'calmo', 'nervoso', 'tranquilo', 'preocupado', 'relaxado',
    'cansado', 'descansado', 'doente', 'saudável', 'faminto', 'cheio', 'sedento', 'sono',
    'acordado', 'vivo', 'morto', 'normal', 'estranho', 'comum', 'raro', 'especial',
    'único', 'primeiro', 'último', 'próximo', 'anterior', 'seguinte', 'principal',
    'secundário', 'público', 'privado', 'nacional', 'internacional', 'local', 'global',
    'social', 'cultural', 'económico', 'político', 'religioso', 'científico', 'artístico',
    // Advérbios
    'muito', 'pouco', 'mais', 'menos', 'bastante', 'demais', 'quase', 'apenas', 'somente',
    'também', 'ainda', 'sempre', 'nunca', 'jamais', 'já', 'agora', 'hoje', 'ontem',
    'amanhã', 'antes', 'depois', 'cedo', 'tarde', 'logo', 'então', 'aqui', 'ali', 'lá',
    'cá', 'aí', 'onde', 'aonde', 'dentro', 'fora', 'perto', 'longe', 'acima', 'abaixo',
    'adiante', 'atrás', 'bem', 'mal', 'assim', 'devagar', 'depressa', 'rapidamente',
    'lentamente', 'claramente', 'certamente', 'provavelmente', 'possivelmente', 'talvez',
    'sim', 'não', 'talvez', 'claro', 'exactamente', 'realmente', 'verdadeiramente',
    // Saudações e expressões
    'olá', 'oi', 'bom', 'boa', 'dia', 'tarde', 'noite', 'adeus', 'tchau', 'até', 'logo',
    'obrigado', 'obrigada', 'de', 'nada', 'por', 'favor', 'desculpe', 'desculpa', 'perdão',
    'com', 'licença', 'parabéns', 'felicidades', 'saúde', 'bem-vindo', 'bem-vinda'
  ],
  en: [
