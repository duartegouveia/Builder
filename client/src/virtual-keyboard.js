...
// Portuguese dictionary from SMenigat/thousand-most-common-words (GitHub)
// 878 most common Portuguese words
const dictionaries = {
  pt: [
    'como', 'seu', 'que', 'ele', 'foi', 'para', 'em', 'são', 'com', 'eles', 'ser', 'uma', 'tem',
    'este', 'por', 'quente', 'palavra', 'mas', 'alguns', 'você', 'ou', 'teve', 'de', 'nós',
    'lata', 'fora', 'outro', 'foram', 'fazer', 'tempo', 'se', 'vontade', 'disse', 'cada',
    'dizer', 'faz', 'conjunto', 'três', 'quer', 'ar', 'bem', 'também', 'jogar', 'pequeno',
    'fim', 'colocar', 'casa', 'ler', 'mão', 'porto', 'grande', 'soletrar', 'adicionar', 'mesmo',
    'terra', 'aqui', 'necessário', 'alto', 'tais', 'siga', 'ato', 'perguntar', 'homens',
    'mudança', 'fui', 'luz', 'tipo', 'off', 'precisa', 'imagem', 'tentar', 'novamente',
    'animais', 'ponto', 'mãe', 'mundo', 'perto', 'construir', 'auto', 'pai', 'qualquer',
    'novo', 'trabalho', 'parte', 'tomar', 'obter', 'lugar', 'feito', 'viver', 'onde', 'depois',
    'pouco', 'apenas', 'rodada', 'homem', 'ano', 'veio', 'exposição', 'bom', 'me', 'dar',
    'nossa', 'sob', 'nome', 'muito', 'através', 'justo', 'forma', 'sentença', 'ajudar',
    'baixo', 'linha', 'diferir', 'vez', 'causa', 'significar', 'antes', 'direito', 'menino',
    'velho', 'ela', 'tudo', 'lá', 'quando', 'up', 'usar', 'maneira', 'sobre', 'muitos',
    'escrever', 'faria', 'assim', 'estes', 'longo', 'coisa', 'veja', 'dois', 'olhar', 'mais',
    'dia', 'poderia', 'ir', 'vir', 'fez', 'número', 'som', 'não', 'pessoas', 'meu', 'sei',
    'água', 'chamada', 'primeiro', 'pode', 'lado', 'sido', 'agora', 'encontrar', 'cabeça',
    'ficar', 'próprio', 'página', 'deveria', 'país', 'encontrado', 'resposta', 'escola',
    'crescer', 'estudo', 'ainda', 'aprender', 'planta', 'cobertura', 'alimentos', 'sol',
    'quatro', 'entre', 'estado', 'manter', 'olho', 'nunca', 'último', 'deixar', 'pensava',
    'cidade', 'árvore', 'atravessar', 'fazenda', 'difícil', 'começo', 'poder', 'história',
    'serra', 'longe', 'mar', 'desenhar', 'esquerda', 'tarde', 'run', 'enquanto', 'imprensa',
    'noite', 'reais', 'vida', 'poucos', 'norte', 'livro', 'carregam', 'tomou', 'ciência',
    'comer', 'quarto', 'amigo', 'começou', 'ideia', 'peixe', 'montanha', 'pare', 'base',
    'ouvir', 'cavalo', 'corte', 'certo', 'assista', 'cor', 'rosto', 'madeira', 'principal',
    'aberto', 'parecem', 'juntos', 'próximo', 'branco', 'crianças', 'início', 'andar',
    'exemplo', 'facilidade', 'papel', 'grupo', 'sempre', 'música', 'aqueles', 'tanto',
    'marca', 'carta', 'até', 'milha', 'rio', 'carro', 'pés', 'cuidados', 'segunda',
    'suficiente', 'plain', 'menina', 'habitual', 'jovem', 'pronto', 'acima', 'vermelho',
    'lista', 'embora', 'sentir', 'discussão', 'pássaro', 'corpo', 'cão', 'família', 'direto',
    'representar', 'canção', 'medir', 'porta', 'produto', 'preto', 'curta', 'numeral',
    'classe', 'vento', 'pergunta', 'acontecer', 'completo', 'navio', 'área', 'metade',
    'rocha', 'ordem', 'fogo', 'sul', 'problema', 'peça', 'sabia', 'passar', 'desde', 'topo',
    'inteiro', 'rei', 'rua', 'polegada', 'multiplicar', 'nada', 'curso', 'roda', 'força',
    'azul', 'objeto', 'decidir', 'superfície', 'profunda', 'lua', 'ilha', 'pé', 'sistema',
    'ocupado', 'teste', 'registro', 'barco', 'comum', 'ouro', 'possível', 'avião', 'seca',
    'pergunto', 'risada', 'mil', 'atrás', 'ran', 'verifique', 'jogo', 'equiparar', 'senhorita',
    'trouxe', 'calor', 'neve', 'pneu', 'trazer', 'sim', 'distante', 'preencher', 'leste',
    'pintar', 'linguagem', 'unidade', 'multa', 'voar', 'cair', 'conduzir', 'grito', 'escuro',
    'máquina', 'nota', 'esperar', 'plano', 'figura', 'estrela', 'caixa', 'substantivo',
    'campo', 'resto', 'correto', 'capaz', 'libra', 'done', 'beleza', 'contêm', 'frente',
    'ensinar', 'semana', 'finais', 'deu', 'verde', 'rápida', 'desenvolver', 'oceano', 'livre',
    'minuto', 'forte', 'especial', 'mente', 'claro', 'cauda', 'produzir', 'fato', 'espaço',
    'ouvido', 'melhor', 'horas', 'verdade', 'durante', 'cem', 'cinco', 'lembre-se', 'passo',
    'cedo', 'segurar', 'oeste', 'solo', 'juros', 'alcançar', 'rápido', 'verbo', 'cantar',
    'ouça', 'seis', 'mesa', 'viagens', 'menos', 'manhã', 'dez', 'simples', 'vários', 'vogal',
    'direção', 'guerra', 'lay', 'contra', 'padrão', 'lento', 'centro', 'amo', 'pessoa',
    'dinheiro', 'servir', 'aparecer', 'estrada', 'mapa', 'chuva', 'regra', 'governar', 'puxe',
    'frio', 'aviso', 'voz', 'energia', 'caça', 'provável', 'cama', 'irmão', 'ovo', 'passeio',
    'celular', 'acreditar', 'talvez', 'escolher', 'súbita', 'contar', 'quadrado', 'razão',
    'comprimento', 'arte', 'assunto', 'região', 'tamanho', 'variar', 'resolver', 'falar',
    'peso', 'geral', 'gelo', 'círculo', 'par', 'incluir', 'dividir', 'sílaba', 'sentido',
    'bola', 'onda', 'coração', 'am', 'presente', 'pesado', 'dança', 'motor', 'posição',
    'braço', 'ampla', 'vela', 'fração', 'floresta', 'sentar-se', 'corrida', 'janela', 'loja',
    'verão', 'trem', 'sono', 'provar', 'solitário', 'perna', 'exercício', 'parede', 'captura',
    'mount', 'desejo', 'céu', 'conselho', 'alegria', 'inverno', 'sat', 'escrito', 'selvagem',
    'instrumento', 'guardado', 'vidro', 'grama', 'vaca', 'borda', 'sinal', 'visita', 'passado',
    'suave', 'diversão', 'brilhante', 'gás', 'mês', 'milhão', 'suportar', 'acabamento',
    'feliz', 'esperamos', 'flor', 'vestir', 'estranho', 'gone', 'comércio', 'melodia',
    'viagem', 'escritório', 'receber', 'boca', 'exata', 'símbolo', 'morrer', 'dificuldade',
    'exceto', 'escreveu', 'semente', 'tom', 'juntar-se', 'sugerir', 'limpo', 'pausa',
    'senhora', 'quintal', 'subir', 'ruim', 'golpe', 'óleo', 'sangue', 'tocar', 'cresceu',
    'cento', 'misturar', 'equipe', 'fio', 'custo', 'perdido', 'marrom', 'desgaste', 'jardim',
    'igual', 'enviado', 'caiu', 'caber', 'fluir', 'feira', 'banco', 'recolher', 'salvar',
    'controle', 'decimal', 'bastante', 'quebrado', 'caso', 'meio', 'matar', 'filho', 'lago',
    'momento', 'escala', 'primavera', 'observar', 'criança', 'reta', 'consoante', 'nação',
    'dicionário', 'leite', 'velocidade', 'método', 'órgão', 'pagar', 'idade', 'seção',
    'vestido', 'nuvem', 'surpresa', 'calma', 'pedra', 'minúsculo', 'subida', 'legal',
    'projeto', 'pobre', 'experiência', 'inferior', 'chave', 'ferro', 'único', 'vara', 'plana',
    'vinte', 'pele', 'sorriso', 'vinco', 'buraco', 'saltar', 'bebê', 'oito', 'aldeia', 'meet',
    'raiz', 'comprar', 'levantar', 'empurre', 'sete', 'parágrafo', 'terceiro', 'deve', 'held',
    'cabelo', 'descrever', 'cozinheiro', 'piso', 'resultado', 'queimar', 'hill', 'seguro',
    'cat', 'século', 'considerar', 'bit', 'costa', 'cópia', 'frase', 'silenciosa', 'areia',
    'rolo', 'temperatura', 'dedo', 'indústria', 'valor', 'luta', 'mentira', 'bater', 'excitar',
    'naturais', 'vista', 'capital', 'cadeira', 'perigo', 'frutas', 'rico', 'grossa', 'soldado',
    'processo', 'operar', 'prática', 'separado', 'médico', 'proteger', 'meio-dia', 'colheita',
    'moderno', 'elemento', 'acertar', 'estudante', 'canto', 'festa', 'fornecimento', 'cuja',
    'localizar', 'anel', 'caráter', 'inseto', 'capturados', 'período', 'indicam', 'rádio',
    'falou', 'átomo', 'humano', 'efeito', 'elétrica', 'osso', 'trilho', 'imaginar', 'fornecer',
    'concordar', 'mulher', 'capitão', 'sharp', 'asa', 'criar', 'vizinho', 'lavagem', 'bat',
    'multidão', 'milho', 'comparar', 'poema', 'corda', 'sino', 'dependem', 'carne', 'esfregar',
    'tubo', 'famoso', 'dólar', 'córrego', 'medo', 'fina', 'triângulo', 'planeta', 'apressar',
    'chefe', 'colônia', 'relógio', 'mina', 'amarrar', 'introduzir', 'maior', 'fresco',
    'pesquisa', 'enviar', 'amarelo', 'pistola', 'permitir', 'impressão', 'morto', 'local',
    'deserto', 'terno', 'atual', 'elevador', 'aumentou', 'chegar', 'mestre', 'trilha',
    'divisão', 'folha', 'substância', 'favorecer', 'conectar', 'pós', 'acorde', 'gordura',
    'original', 'share', 'estação', 'pão', 'cobrar', 'adequada', 'bar', 'oferta', 'segmento',
    'escravo', 'pato', 'instant', 'mercado', 'grau', 'pinto', 'caro', 'inimigo', 'responder',
    'bebida', 'ocorrer', 'apoio', 'discurso', 'natureza', 'gama', 'vapor', 'movimento',
    'caminho', 'líquido', 'log', 'significava', 'quociente', 'dentes', 'casca', 'pescoço',
    'oxigênio', 'açúcar', 'morte', 'habilidade', 'mulheres', 'temporada', 'solução', 'ímã',
    'prata', 'obrigado', 'ramo', 'sufixo', 'especialmente', 'figo', 'enorme', 'irmã', 'aço',
    'discutir', 'similar', 'orientar', 'contagem', 'maçã', 'comprou', 'conduziu', 'casaco',
    'massa', 'cartão', 'banda', 'deslizamento', 'vitória', 'sonhar', 'condição', 'alimentação',
    'ferramenta', 'básico', 'cheiro', 'vale', 'nem', 'duplo', 'assento', 'continuar', 'bloco',
    'gráfico', 'chapéu', 'vender', 'sucesso', 'companhia', 'subtrair', 'evento', 'negócio',
    'mergulho', 'prazo', 'oposto', 'esposa', 'sapato', 'ombro', 'propagação', 'organizar',
    'acampamento', 'inventar', 'algodão', 'nascido', 'determinar', 'nove', 'caminhão', 'ruído',
    'nível', 'oportunidade', 'trecho', 'brilho', 'propriedade', 'coluna', 'molécula',
    'selecione', 'errado', 'cinza', 'repetição', 'exigir', 'amplo', 'preparar', 'sal', 'nariz',
    'plural', 'raiva', 'reivindicação', 'continente',
    // Palavras adicionais comuns em português europeu
    'olá', 'oi', 'boa', 'adeus', 'tchau', 'obrigada', 'desculpe', 'desculpa', 'perdão',
    'licença', 'parabéns', 'felicidades', 'saúde', 'bicicleta', 'telemóvel', 'autocarro',
    'comboio', 'estou', 'está', 'estamos', 'estava', 'tenho', 'tinha', 'faço', 'fazia',
    'posso', 'podia', 'quero', 'queria', 'digo', 'dizia', 'vejo', 'via', 'dou', 'dava',
    'vou', 'vai', 'vamos', 'ia', 'venho', 'vinha', 'sabia', 'ponho', 'punha', 'fico',
    'ficou', 'acho', 'penso', 'falo', 'gosto', 'preciso', 'adoro', 'prefiro'
  ],
  en: [
